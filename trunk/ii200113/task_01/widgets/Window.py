...
class AppWindow(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._open_file_btn = _create_button('Open file', self._open_file_clicked)
        self._buttons_layout.addWidget(self._open_file_btn, 1)
        self._remove_noise_btn = _create_button('Remove noise', self._remove_noise_clicked)
        self._buttons_layout.addWidget(self._remove_noise_btn, 1)
        self._add_noise_btn = _create_button('Create noise button', self._add_noise_clicked)
